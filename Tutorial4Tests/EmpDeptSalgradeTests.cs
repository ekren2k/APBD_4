...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        var query = from emp in emps where emp.DeptNo == 30 orderby emp.Sal descending select emp;
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = (from emp in emps where 
                            ...
                            .Contains(emp.DeptNo) select emp).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = (from emp in emps where emp.Comm != null select new
        {
            emp.EmpNo,
            emp.Comm
        ...
        var result = (from emp in emps
            where emp.Sal >
                  (from e in emps
                      ...
                      select e.Sal).Average() select emp.EName).ToList();
